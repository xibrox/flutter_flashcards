...
int _categoryEstimateSize(
  ...
  bytesCount += 3 + object.flashcards.length * 3;
  {
    ...
    for (var i = 0; i < object.flashcards.length; i++) {
      ...
      bytesCount += FlashcardSchema.estimateSize(value, offsets, allOffsets);
    }
  }
...
Category _categoryDeserialize(
  ...
  object.flashcards =
      reader.readObjectList<Flashcard>(
        offsets[0],
...
extension CategoryQueryFilter
  ...
  flashcardsLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'flashcards', length, true, length, true);
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition> flashcardsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'flashcards', 0, true, 0, true);
    });
  }
  ...
  flashcardsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'flashcards', 0, false, 999999, true);
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition>
  flashcardsLengthLessThan(int length, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'flashcards', 0, true, length, include);
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition>
  flashcardsLengthGreaterThan(int length, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'flashcards', length, include, 999999, true);
    });
  }
...
extension CategoryQueryObject
    on QueryBuilder<Category, Category, QFilterCondition> {
  QueryBuilder<Category, Category, QAfterFilterCondition> flashcardsElement(
...
extension CategoryQueryProperty
  ...
  QueryBuilder<Category, List<Flashcard>, QQueryOperations>
  flashcardsProperty() {
    return QueryBuilder.apply(this, (query) {
